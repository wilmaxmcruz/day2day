...
/****** Interface *******/
/************************/
function createScatterplot(data, reload)
{	
	...
	var scatterplot = new Scatterplot(config.name + "Graphic", config, data);
	scatterplot.render();
	_graphics.push(scatterplot);
}

/********************/
/****** Class *******/
/********************/
function Scatterplot(placeholderName, configuration, data)
{
