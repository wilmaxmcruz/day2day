...
/****** Interface *******/
/************************/
function createDoubleScatterplotForScale(data, reload)
{		
	...
	var scatterplotForScale = new DoubleScatterplotForScale(config.name + "Graphic", config, data);
...
/****** Class *******/
/********************/
function DoubleScatterplotForScale(placeholderName, configuration, data)
{
